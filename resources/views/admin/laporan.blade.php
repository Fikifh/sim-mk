                    ...
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                <b>NIP</b> <a class="float-right">19851211 201101 1 009</a>
                            </li>
                            <li class="list-group-item">
                                <b>Pangkat/Gol.Ruang</b> <a class="float-right">Penata Muda III/c</a>
                            </li>
                            <li class="list-group-item">
                                <b>Unit Kerja</b> <a class="float-right">Biro Perencanaan dan Organisasi</a>
                            </li>
                        </ul>
                        <div class="row">
