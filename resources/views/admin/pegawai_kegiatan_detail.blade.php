                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card col-6">
                            <div class="card-header">
                                <b>Pegawai : {{ $kegiatan->pegawai->nama }}</b>
                            </div>
                            <div class="card-body">
                                <table>
                                    <tr>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <p class="lead">Kegiatan Tugas Jabatan:</p>
                                            ...
                                            <div class="row no-print">
                                                <div class="col-12">
                                                    ...
                                                    @else
                                                        ...
                                                        <a href=""
                                                            title="Download  File">
                                                            <button type="button" disabled="true" class="btn aqua-gradient float-right">
                                                                <i class="fas fa-upload"></i> Download File
                                                            </button>
                                                        </a>
