            ...
            <div class="row">
                <div class="col-4">
                    <table class="" style="margin-bottom:10px;">
                        <?php
                            $user = $indikator_kinerjas->first()->pegawai;
                        ?>
                        @if ($user)
                            <tr>
                                <td>1. </td>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-muted" style="margin-top : 10px;">Indikator Kinerja:
                                    {{ $indikator_kinerja->nama }}</h3>
                                <div class="float-right">
                                    <a href="#addKegiatanTugasJabatan" data-toggle="modal" data-id="{{ $indikator_kinerja->id }}"
                                            ...
                                            @foreach ($indikator_kinerja->kegiatanTugasJabatan as $tugasJabatan)
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="#editSasaran" data-toggle="modal"
                                                            data-id="{{ $tugasJabatan->id }}" title="Edit Sasaran Kegiatan">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="#addIndikatorKinerja" data-toggle="modal"
                                                            data-id="{{ $tugasJabatan->id }}" title="Tambah Indikator Kinerja">
                                                            <i class="fas fa-plus"></i>
                                                        </a>
                                                        <a href="#deleteSasaran" data-toggle="modal"
                                                    ...
                                                    <?php 
                                                        $perhitungan = ($perhitungan + ($tugasJabatan->mutu_target + $tugasJabatan->mutu_realisasi) / $jumlahRow);
                                                        $nilaiCapaian = ($nilaiCapaian + ( ($tugasJabatan->mutu_target + $tugasJabatan->mutu_realisasi) / 2) / $jumlahRow);
                                                    ?>
                                                </tr>
                                            @endforeach
                                        </tbody>
                ...
                <div class="modal-body">
                    <form action={{ route('admin_pegawai_add_tugas_jabatan') }} method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="uraian_kegiatan" class="form-control" required="true" id="add_kegiiatan_tugas_uraian">
                            <input type="number" hidden="true"  name="indikator_kerjas_id" class="form-control" required="true" id="add_kegiiatan_indikator_kerja_id">
                            <input type="number" hidden="true"  name="user_id" class="form-control" required="true" id="add_kegiatan_indikator_kerja_user_id">
                            <small class="text-muted">tanda (*) adalah wajib diisi</small>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">AK Target(*):</label>
                            <input type="number" name="ak_target" class="form-control" required="true" id="add_kegiiatan_tugas_ak_target">
                            <small class="text-muted">tanda (*) adalah wajib diisi</small>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Mutu Target(*):</label>
                            <input type="number" name="mutu_target" class="form-control" required="true" id="add_kegiiatan_tugas_mutu_target">
                            <small class="text-muted">tanda (*) adalah wajib diisi</small>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Qty Target(*):</label>
                            <input type="number" name="qty_target" class="form-control" required="true" id="add_kegiiatan_tugas_qty_target">
                            <small class="text-muted">tanda (*) adalah wajib diisi</small>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">AK Realisasi:</label>
                            <input type="number" name="ak_realisasi" class="form-control" id="add_kegiiatan_tugas_ak_realisasi">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Mutu Realisasi:</label>
                            <input type="number" name="mutu_realisasi" class="form-control" id="add_kegiiatan_tugas_mutu_realisasi">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Qty Realisasi:</label>
                            <input type="text" name="qty_realisasi" class="form-control" id="add_kegiiatan_tugas_qty_realisasi">
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action={{ route('admin_pegawai_add_tugas_jabatan') }} method="POST">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Kegiatan Tugas Jabatan (*):</label>
                            <input type="text" name="uraian_kegiatan" class="form-control" required="true" id="edit_kegiiatan_tugas_uraian">
                            <input type="number" hidden="true"  name="indikator_kerjas_id" class="form-control" required="true" id="edit_kegiiatan_indikator_kerja_id">
                            <input type="number" hidden="true"  name="user_id" class="form-control" required="true" id="edit_kegiatan_indikator_kerja_user_id">
                            <small class="text-muted">tanda (*) adalah wajib diisi</small>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">AK Target(*):</label>
                            <input type="number" name="ak_target" class="form-control" required="true" id="edit_kegiiatan_tugas_ak_target">
                            <small class="text-muted">tanda (*) adalah wajib diisi</small>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Mutu Target(*):</label>
                            <input type="number" name="mutu_target" class="form-control" required="true" id="edit_kegiiatan_tugas_mutu_target">
                            <small class="text-muted">tanda (*) adalah wajib diisi</small>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Qty Target(*):</label>
                            <input type="number" name="qty_target" class="form-control" required="true" id="edit_kegiiatan_tugas_qty_target">
                            <small class="text-muted">tanda (*) adalah wajib diisi</small>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">AK Realisasi:</label>
                            <input type="number" name="ak_realisasi" class="form-control" id="edit_kegiiatan_tugas_ak_realisasi">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Mutu Realisasi:</label>
                            <input type="number" name="mutu_realisasi" class="form-control" id="edit_kegiiatan_tugas_mutu_realisasi">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Qty Realisasi:</label>
                            <input type="text" name="qty_realisasi" class="form-control" id="edit_kegiiatan_tugas_qty_realisasi">
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary">Tambah</button>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
