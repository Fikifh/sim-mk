        ...
        <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                  ...
                  <div class="card-body">
                    <p>
                    Berdasarkan Perolehan Penilaian yang sudah dilakukan para pegawai mempunyai performa rata - rata <b> {{$kriteria ? $kriteria->nilai_text :  ''}}</b> dengan nilai capaian <b>{{round($summary->nilai_capaian, 2)}}
                    </p>
                  </div>
              </div>
            </div>
