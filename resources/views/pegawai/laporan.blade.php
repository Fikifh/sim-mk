        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <ul class="list-group list-group-unbordered mb-12">
                    <li class="list-group-item">
                        <a class="float-left text-muted" style="margin-left: 10px;">  Tanggal {{ \Carbon\Carbon::parse($from)->format('d M Y') }}
                            sampai {{ \Carbon\Carbon::parse($to)->format('d M Y') }}</a>

                        <a class="float-right"
                            href={{ route('admin_laporan_pegawai', ['pegawai_id' => $pegawai_id, 'from' => $from, 'to' => $to, 'is_print' => true]) }}
                            target="_blank">
                            <button id="add_kegiatan_id" type="button"
                                class="btn btn-sm purple-gradient bg-gradient-primary btn-flat add_kegiatan">
